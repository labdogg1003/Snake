...
struct  Serializer_t2355519699  : public Il2CppObject
{
public:
...
public:
	inline static int32_t get_offset_of_builder_0() { return static_cast<int32_t>(offsetof(Serializer_t2355519699, ___builder_0)); }
