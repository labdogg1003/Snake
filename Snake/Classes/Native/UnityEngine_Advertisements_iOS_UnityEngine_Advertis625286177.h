...
struct  DebugLevelInternal_t625286177 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(DebugLevelInternal_t625286177, ___value___1)); }
